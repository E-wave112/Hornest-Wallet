...
export class TransactionsService {
    ...
    async createTransaction(payload:object):Promise<Transactions> {
        try {
            const newTransaction:Transactions = this.TransactionsRepository.create(payload);
    ...
    async deleteUserTransaction(transactionId:string):Promise<Transactions> {
        try {
            const deletedTransaction = await this.TransactionsRepository.findOne(transactionId);
