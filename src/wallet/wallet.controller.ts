...
export class WalletController {
    ...
    @Post('user/fund-wallet/:id')
    async fundWallet(@Request() req, @Param() params) {
        ...
        const wallet = await this.walletService.checkIfWalletExists({where:{user:req.user.id}})
